...
print "NT2_DRIP Pval (Original > Shuffled) = $pvalUp, Shuffled_Intersect = $mean, Original_Intersect = $NT2_DRIPPerc\n" if $pvalUp < 0.05;
print "NT2_DRIP Pval (Original < Shuffled) = $pvalDown, Shuffled_Intersect = $mean, Original_Intersect = $NT2_DRIPPerc\n" if $pvalDown < 0.05;
__END__
my $Rscript = "
