...
#   21663324 3T3.sam
#   24055761 E14.sam
#   2388895 3T3.reads_nofeature.sam
#   2537456 E14.reads_nofeature.sam
#  64770299 Fibro.sam
#  10924493 Fibro.reads_nofeature.sam
...
# Find N
my $N = $input =~ /E14/ ? 24055761-2537456 : $input =~ /NT2/ ? 21663324-2388895 : 64770299-10924493;

# Process exon bed file to get length (L)
print "1. Processing exon bed file ../../2_RNAseq/1_DefineExonIntron/hg19_gencode19_exon.bed file\n";
my %data;
open (my $in1, "<", "../../2_RNAseq/1_DefineExonIntron/hg19_gencode19_exon.bed") or die "Cannot read from ../../2_RNAseq/1_DefineExonIntron/hg19_gencode19_exon.bed: $!\n";
while (my $line = <$in1>) {
	chomp($line);
