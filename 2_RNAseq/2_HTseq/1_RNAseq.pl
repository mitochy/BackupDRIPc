...
my $proteinGTF   = "/data/mitochi/Work/Project/DRIPc/2_RNAseq/1_DefineExonIntron/hg19_gencode19_exon_proteincoding.gtf";
my $noncodingGTF = "/data/mitochi/Work/Project/DRIPc/2_RNAseq/1_DefineExonIntron/hg19_gencode19_exon_noncoding.gtf";
...
print GREEN "\t2. Combining exon rnacount into $RNAsamName\_hg19_gencode19_exon.rnacount\n";
system("rm $RNAsamName\_hg19_gencode19_exon.rnacount") if -e "$RNAsamName\_hg19_gencode19_exon.rnacount";
print "\tcat $RNAsamName\_hg19_gencode19_exon_proteincoding.rnacount $RNAsamName\_hg19_gencode19_exon_noncoding.rnacount > $RNAsamName\_hg19_gencode19_exon.rnacount\n";
system("cat $RNAsamName\_hg19_gencode19_exon_proteincoding.rnacount $RNAsamName\_hg19_gencode19_exon_noncoding.rnacount > $RNAsamName\_hg19_gencode19_exon.rnacount");

fix_count("$RNAsamName\_hg19_gencode19_exon.rnacount");
