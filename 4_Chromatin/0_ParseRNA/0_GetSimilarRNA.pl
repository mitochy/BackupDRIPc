...
# Output: 
# 1. NT2_RNAtwin.rpkm 
# 2. NT2_RNAzero.rpkm for all genes with less than 10 RPKM

use strict; use warnings; use mitochy;

my ($input) = "/data/mitochi/Work/Project/DRIPc/data/NT2.rpkm";
...
open (my $out, ">", "../1_Shuffle/NT2_RNAtwin.rpkm") or die "Cannot write to NT2_RNAtwin.rpkm: $!\n";
open (my $out2, ">", "../1_Shuffle/NT2_RNAzero.rpkm") or die "Cannot write to NT2_RNAtzero.rpkm: $!\n";
my $count = 0;
