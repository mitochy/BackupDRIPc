...
use vars qw($opt_r $opt_a $opt_b);
getopts("r:a:b:");

die "
usage: $0 -r <RNAseq> -a <orig.tsv e.g. MCF_groseq_promoter_orig.tsv> -b <shuf.tsv>
...
print "2. Dividing orig tsv $origFile\n";
...
print "3. Dividing Shuffled tsv $shufFile\n";
...
# Run Graph.pl
runbash("./1b_Graph_meth_5Exp.pl $fileNameOrig\_high.temp");
