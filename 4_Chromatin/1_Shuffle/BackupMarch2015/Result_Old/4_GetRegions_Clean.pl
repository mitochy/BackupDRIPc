...
sub getCoorFixed {
	...
	# CENTERED ON DRIPC
	$gencode = "/data/mitochi/Work/Project/DRIPc/1_Location/4_CreateRegion_Clean/DRIPc/dripc_promoter.bed" if $input =~ /promoter/;
	$gencode = "/data/mitochi/Work/Project/DRIPc/1_Location/4_CreateRegion_Clean/DRIPc/dripc_terminal.bed" if $input =~ /terminal/;
