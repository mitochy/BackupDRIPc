...
if ($input =~ /promoter\./) {
	open (my $inprom, "<", "/data/mitochi/Work/Project/DRIPc/bed/hg19_gencode_promoter.bed") or die "Cannot read from /data/mitochi/Work/Project/DRIPc/bed/hg19_gencode_promoter.bed: $!\n";
	...
	open (my $interm, "<", "/data/mitochi/Work/Project/DRIPc/bed/hg19_gencode_terminal.bed") or die "Cannot read from /data/mitochi/Work/Project/DRIPc/bed/hg19_gencode_terminal.bed: $!\n";
...
if ($input =~ /intergenic/) {
	...
	print $outLog "Not Used DRIPc < 5: $count_notused_lowdripc, Number of Twin < 500: $count_notused_lowtwin, Shuffles less than <500: $count_notused_lowtwin2\n";
