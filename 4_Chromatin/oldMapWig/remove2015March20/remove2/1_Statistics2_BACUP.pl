...
print $outFold "$feature\t$histone\t$meanadjpval\t$higher,$lower,$notsig\t$usd\t$total\t$fold\n" if $meanadjpval <= 0.05;
print $outFold "$feature\t$histone\t$meanadjpval\tNS\t$usd\t$total\t$fold\n" if $meanadjpval > 0.05;
=comment
